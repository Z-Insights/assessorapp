// FILE: schema.js
// VERSION: 3.2 - Production Release with Delta Report Inspection Type
// DATE: February 3, 2026
// CLASSIFICATION: Inspection Protocol Definitions - Field-Optimized + Office Analysis
// 
// CRITICAL CHANGES FROM v3.1:
// - Added new "deltaReport" inspection type for office-based comparative analysis
// - Maintained field-simplified Move-In/Move-Out inspections from v3.1
// - Enhanced conditional guidance throughout all inspection types
// - Removed all legal jargon and L10 application language from field inspections
// 
...
// 5. DELTA REPORT: Office analysis comparing Move-In vs Move-Out (NEW in v3.2)
...
const CHECKLIST_SCHEMAS = {
	...
	// ============================================================================
	// Purpose: Periodic safety verification during active tenancies
	// Frequency: Quarterly or semi-annually
	// User: Field runner during tenant occupancy
	...
	// ============================================================================
	// Purpose: Verify unit meets market standards before advertising
	// Trigger: Between tenancies, post-cleaning, pre-marketing
	// User: Property manager or senior inspector
	...
	// ============================================================================
	// Purpose: Document unit condition BEFORE tenant moves in
	// Output: Creates exportable .json baseline file for future comparison
	// User: Field runner with new tenant present
	// Duration: 45-60 minutes
	// Critical: This establishes the "pristine" baseline for all future damage claims
	...
	// ============================================================================
	// Purpose: Document unit condition AFTER tenant moves out
	// Note: Field runners just observe and photograph - NO comparison or cost calculation
	// User: Field runner after tenant vacates
	// Duration: 45-60 minutes
	// Next Step: Office staff will use Delta Report inspection to compare vs Move-In baseline
	...
	// ============================================================================
	// DELTA REPORT: Office Comparative Analysis (NEW in v3.2)
	// ============================================================================
	// Purpose: Office-based comparison of Move-In vs Move-Out to identify damage and calculate costs
	// Trigger: Available only when Move-Out inspection is complete
	// User: Property manager or office staff (NOT field runners)
	// Duration: 60-90 minutes
	// Inputs: Requires Move-In baseline (via JSON import or QR scan) + completed Move-Out report
	// Output: Detailed damage assessment with cost calculations ready for legal proceedings
	// 
	// WORKFLOW:
	// 1. Property manager selects "Delta Report" inspection type
	// 2. System prompts to import Move-In baseline via JSON file upload or QR code scan
	// 3. System prompts to import Move-Out report via JSON file upload or QR scan
	// 4. Checklist items guide through systematic comparison and cost calculation
	// 5. Generated report includes side-by-side photo comparisons and total claim amount
